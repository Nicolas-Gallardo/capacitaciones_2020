...
def det_duckie(obs):
    lower_yellow = np.array([140, 130, 0])
 ...
 #Transformar imagen a espacio HSV
    ...
    imgFilt=cv2.bitwise_and(imgHSV,imgHSV,mask=filtro)
    ...
    imgFilt1=cv2.erode(imgFilt,kernel,iterations=1)
        #Operacion morfologica dilate
    imgFilt2=cv2.dilate(imgFilt1,kernel,iterations=1)
...
if __name__ == '__main__':
    ...
    C = 7.6239*8 #f calculada aproximadamente *dr
